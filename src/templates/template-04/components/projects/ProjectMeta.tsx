  ...
  export function ProjectMeta({
    ...
    return (
      <div className="w-full border border-[var(--border)] rounded-lg p-3 bg-[var(--muted)] max-w-2xl">
        ...
        <div className="sm:hidden grid grid-cols-2 gap-4">
          ...
          {status && (
            <div className="flex flex-col gap-1">
              ...
              <div className={`flex items-center gap-2 px-3 py-1 rounded-full border ${statusStyles.container}`}>
